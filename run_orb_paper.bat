@echo off
chcp 65001 >nul
rem Launcher for orb_robot.py --mode paper (live QUIK bars, no real orders sent).
rem Keep the right contract's M15 chart open in QUIK with the chart_tag from
rem config_orb.yaml before starting this.
rem
